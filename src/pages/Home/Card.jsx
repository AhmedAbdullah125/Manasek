...
export default function Card() {
    ...
    let usersData = [
        { id: 1, img: user1, code: rand, name: "عبد الرحمن ابراهيم امين عبد الحميد",nameEng:"Abdulrahman Ibrahim Amen", career: "عامل", passportNum: "A30362793", birthDate: Date("06/04/1990") },
    ]
    return (
